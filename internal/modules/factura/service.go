...
func (s *facturaService) EmitirFactura(factura *Factura) (*Factura, error) {
	...
	// 2️⃣ Validar que el pedido esté pagado
	...
	// 3️⃣ Verificar si ya existe factura para este pedido
